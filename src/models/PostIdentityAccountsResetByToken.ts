...
export type PostIdentityAccountsResetByTokenMutationRequest = ResetByTokenRequest
/**
 * @description OK
 */
export type PostIdentityAccountsResetByTokenMutationResponse = CommonMessageResponse
