...
export const sendMailRequestSchema = z.object({ email: z.coerce.string().nullable().nullish(), type: z.lazy(() => verificationTypeSchema).optional() }) as z.ZodType<SendMailRequest>
